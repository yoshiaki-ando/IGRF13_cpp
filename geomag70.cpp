...
(
 ...
 double alt, double latitude, double longitude,
 ...
 )
{
  ...
  int   nmax;
  int   igdgc=3;
  //int   isyear=-1; /* argument */
  //int   ismonth=-1; /* argument */
  //int   isday=-1; /* argument */
  int   ieyear=-1;
  int   iemonth=-1;
  int   ieday=-1;
  int   ilat_deg=200;
  ...
  double minalt;
  double maxalt;
  //double alt=-999999; /* argument */
  double sdate=-1;
  double step=-1;
  double syr;
  double edate=-1;
  //double latitude=200; /* argument */
  //double longitude=200; /* argument */
  double ddot;
  double fdot;
  double hdot;
  double idot;
...
int dihf (int gh, double &d, double &i, double &f)
// int gh;
{
  int ios;
  int j;
